...
void odom_estimation(){
    while(1){
        ...
        if(total_frame % 600 == 0 && total_frame != 0){
            pcl::io::savePCDFileASCII(ws_path+"/data/map/surfaceMap_pre.pcd",*odomEstimation.laserCloudSurfMap);
            pcl::io::savePCDFileASCII(ws_path+"/data/map/edgeMap_pre.pcd",*odomEstimation.laserCloudCornerMap);
        }
